...
Staff need an aggregate view of accounts-payable exposure — total outstanding liabilities bucketed by due date — without inspecting every invoice individually.
